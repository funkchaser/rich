...
data_collected = get_param_component(ghdoc, component_nickname="Result")
...
new_solution(ghdoc)
data_collected = get_param_component(ghdoc, component_nickname="Result") #-> does not update result
